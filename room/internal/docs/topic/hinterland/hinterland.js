global.rooms['internal.docs.topic.hinterland'] = foundation => decorator => {
  ...
  hinterlandFormInit.text(0.5, 'Hinterland.prototype.init(shortName, fullName, { hosting, debug, habitats, recordForms, above, below })');
  ...
  hinterlandFormInit.text(0.2, '<param> Function above');
  hinterlandFormInit.text(0.2, '<param> Function below');
